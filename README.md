...
1. Fundamentos básicos
   ...
   7. Compartilhando estado entre componentes com _elevação de estado_ (lifiting state): [aplicação de contadores](fundamentos/07-elevacao_de_estado.md) e [aplicação de tarefas](fundamentos/07-elevacao_de_estado-tarefas.md)
6. Colocando estilos
